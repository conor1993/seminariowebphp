<html>
	...
	<body>
	          <div class="col-md-12">
                ...
                <label class="label-estilo" ><h3 style="text-align: center;">Boletos Liquidados</h3></label>
								                 ...
								                 <tbody id="tbodyCodigo">
													<?php 
								 						if(isset($pen)){
								 							foreach ($pen as $li) {
									 								echo '<tr">';
										 								echo '<td>'.$li->colnombre.' '.$li->colapellidop.' '.$li->colapellidom.'</td>';
										 								echo '<td>'.$li->gestornombre.' '.$li->gesapellido.' '.$li->gesapellidom.'</td>';
										 								echo '<td>'.$li->pago.'</td>';
									 								echo '</tr>';
